#
# Makefile created at Thu Nov 26 13:57:04 2015, by mmake
#
...
#package targets
FileTransferServer : $(call PACKAGE_OBJS,FileTransferServer)
FileTransferClient : $(call PACKAGE_OBJS,FileTransferClient)
